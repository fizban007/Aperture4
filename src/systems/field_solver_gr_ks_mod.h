...
#include "systems/field_solver_mod.h"
...
class field_solver_mod<Conf, ExecPolicy, coord_policy_gr_ks_sph>
 ...
 public:
  ...
  field_solver_mod(const grid_ks_t<Conf>& grid,
               const domain_comm<Conf, ExecPolicy>* comm = nullptr);

  virtual ~field_solver_mod();
