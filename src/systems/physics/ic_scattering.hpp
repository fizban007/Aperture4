...
struct ic_scatter_t {
  ...
  HD_INLINE int find_n_gamma(value_t gamma) {
  ...
  HOST_DEVICE value_t ic_scatter_rate(value_t gamma) {
    int n_gamma = find_n_gamma(gamma);
  ...
  HOST_DEVICE value_t gg_scatter_rate(value_t eph) {
