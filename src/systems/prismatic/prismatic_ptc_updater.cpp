...
// =========================================================================
// HD_INLINE coordinate conversion helpers
// =========================================================================
...
void prismatic_ptc_updater::update(double dt, uint32_t step) {
  ...
  for (size_t n = 0; n < num; n++) {
    ...
    Scalar tx = qdt_2m*Bx/gamma_mid, ty = qdt_2m*By/gamma_mid, tz = qdt_2m*Bz/gamma_mid;
    ...
    if (!check_flag(ptrs.flag[n], PtcFlag::ignore_current)) {
      ...
      deposit_current(mp, tri_idx, layer_idx, l_old, zeta,
                      ...
                      q * ptrs.weight[n] / Scalar(dt),
                      J_e, dep_tri, dep_layer);
    }
