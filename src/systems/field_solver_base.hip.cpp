...
template class field_solver<Config<1>, exec_policy_cuda,
                            coord_policy_cartesian>;
template class field_solver<Config<2>, exec_policy_cuda,
                            coord_policy_cartesian>;
template class field_solver<Config<3>, exec_policy_cuda,
                            coord_policy_cartesian>;
